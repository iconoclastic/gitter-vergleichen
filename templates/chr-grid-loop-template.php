...
function chr_loadmore_ajax_handler_template(){
	...
	<?php if( $the_query->have_posts() ): ?>
		<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
			<div class="grid-item"  style="border-bottom: 5px solid <?php echo $grid_color; ?>">
				<a href="<?php the_permalink(); ?>">
...
add_action('wp_ajax_loadmore', 'chr_loadmore_ajax_handler_template'); // wp_ajax_{action}
add_action('wp_ajax_nopriv_loadmore', 'chr_loadmore_ajax_handler_template'); // wp_ajax_nopriv_{action}
